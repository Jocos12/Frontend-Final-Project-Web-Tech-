...
const HomePage = () => {
  ...
  return (
    <div className="home-page">
        ...
        <nav className="home-navbar home-navbar-expand-lg home-navbar-light bg-light"> {/* Changed class names */}
          ...
          <div className="home-collapse navbar-collapse" id="navbarNav"> 
            ...
            <div className="home-collapse navbar-collapse" id="navbarNav"> {/* Changed class name */}
              <div className="home-navbar-nav ml-auto">
                <Link className="home-link-course" to="/course">
                  <FaListAlt className="home-icon" />
                  <div className="home-link-text">Courses</div>
                </Link>
                <Link className="home-link-claims" to="/about">
                  <FaCommentAlt className="home-icon" />
                  <div className="home-link-text">About Our System</div>
                </Link>
                <Link className="home-link-exam" to="/exam">
                  <FaRegChartBar className="home-icon" />
                  <div className="home-link-text">Exams</div>
                </Link>
                <Link className="home-link-transcript" to="/studentexam">
                  <FaBook className="home-icon" />
                  <div className="home-link-text">Information About Exams</div>
                </Link>
      ...
      <main>
        <h1 className="home-animated-text">Welcome to the Exam Management System</h1> {/* Changed class name */}
